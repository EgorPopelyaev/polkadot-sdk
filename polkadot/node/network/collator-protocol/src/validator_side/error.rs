...
<<<<<<< HEAD:polkadot/node/network/collator-protocol/src/error.rs
=======
...
>>>>>>> 07827930 (Use original pr name in prdoc check (#60)):polkadot/node/network/collator-protocol/src/validator_side/error.rs
}
